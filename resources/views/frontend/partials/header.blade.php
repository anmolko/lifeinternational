...
<head>
    ...
    <meta name="author" content="Life International Overseas">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="@if(!empty(@$setting_data->meta_description)) {{ucwords(@$setting_data->meta_description)}} @else Life International Overseas @endif "/>
    <meta name="keywords" content="@if(!empty(@$setting_data->meta_tags)) {{@$setting_data->meta_tags}} @else Recruitment agency, life international, overseas recruitment @endif ">
    <meta name="csrf-token" content="{{ csrf_token() }}" />
    <link rel="canonical" href="https://lifeinternationaloversea.com/" />

    <!-- Title of Site -->
    @if (\Request::is('/'))
        <title>@if(!empty(@$setting_data->website_name)) {{ucwords(@$setting_data->website_name)}} @else Life International Overseas @endif </title>
    @else
        <title>@yield('title') | @if(!empty(@$setting_data->website_name)) {{ucwords(@$setting_data->website_name)}} @else Life International Overseas @endif </title>
    @endif

    <meta property="og:title" content="@if(!empty(@$setting_data->meta_title)) {{ucwords(@$setting_data->meta_title)}} @else  Life International Overseas @endif" />
    <meta property="og:type" content="Consultancy" />
    <meta property="og:url" content="https://lifeinternationaloversea.com/" />
    <meta property="og:site_name" content="Life International Overseas" />
    <meta property="og:description" content="@if(!empty(@$setting_data->meta_description)) {{ucwords(@$setting_data->meta_description)}} @else Life International Overseas @endif " />

    <link rel="shortcut icon" type="image/x-icon" href="{{ (@$setting_data->favicon) ? asset('/images/settings/'.@$setting_data->favicon): asset('assets/frontend/img/favicon-1.png') }}">
